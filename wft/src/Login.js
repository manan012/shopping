    ...
    return(
      <div className="back-login">
        <div className="loader">
          <div className="inner" style={{background:'url("WFT.png") center center no-repeat'}}>
          </div>
        </div>
        <div className="materialContainerLogin">
          ...
          <div className="box">
            ...
            <div className="button login">
              <button onClick={this.submitLogin.bind(this)}><span>Lets Hunt</span> <i className="fa fa-check"></i></button>
            </div>
        ...
        <div className="nocy">
          <a className="names" style={{backgroundImage: 'url("Untitled.png")'}} href="https://www.facebook.com/JuetFirefoxClub/" target='_blank'><span><strong>Developed By</strong><br/>Manan Goel<br/>Shubham Singh<br/>Sharif Nawaz<br/>Arpit Verma<br/>Parteek Chauhan <br/>Muskan Sanghai</span></a>

    ...
    return (
      <div className="back-dash">
        <div>
          ...
          <nav className="navbar navbar-inverse navbarx transparent">
            <div className="container-fluid">
              <div className="navbar-header">
                ...
                <a className="navbar-brand"><img className="headimg" src="https://i.imgur.com/wqDLsau.png" alt="logo"/></a>
              </div>
              ...
              <div className="panel panel-default">
                <div className="panel-body">
                  ...
                  <div className="row">
                    <div className="col-md-4"></div>
                    <div className="col-md-4">
                      <input className="input-answer" name="answer" type="text" placeholder="Enter your Answer" onChange={this.handleChange.bind(this)} value={this.state.answer} />
                    </div>
                  </div>
                </div>
              </div>
